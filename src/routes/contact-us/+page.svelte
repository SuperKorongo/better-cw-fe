...
<main>
	<div class="container">
		...
		<form on:submit|preventDefault={handleSubmit}>
			<Textfield label={getTranslation('contact.email')} type="email" bind:value={email} required />

			<Textfield label={getTranslation('contact.subject')} bind:value={subject} required />
